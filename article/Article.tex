...
\subfigure[User defined labels colored with LabelOverlayImageFilter]{\includegraphics[scale=0.7]{cthead1-markers-rgb}}
...
watershed, not shown here).\label{fig:difficult-cases}}
\end{center}
\end{figure}
