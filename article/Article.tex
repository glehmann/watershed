...
\begin{center}
\subfigure[Input image]{\includegraphics[scale=4]{threshold}}
\subfigure[No minima threshold]{\includegraphics[scale=4]{threshold00-itk-rgb}}
\subfigure[Minima threshold = 10]{\includegraphics[scale=4]{threshold10-itk-rgb}}
% \subfigure[Minima threshold = 20]{\includegraphics[scale=4]{threshold20-itk-rgb}}
\subfigure[Minima threshold = 40]{\includegraphics[scale=4]{threshold40-itk-rgb}}
\subfigure[Minima threshold = 63]{\includegraphics[scale=4]{threshold63-itk-rgb}}
\subfigure[Minima threshold = 65]{\includegraphics[scale=4]{threshold65-itk-rgb}}
\subfigure[markers]{\includegraphics[scale=4]{threshold-markers}}
\subfigure[Watershed from markers]{\includegraphics[scale=4]{threshold-markers-itk-rgb}}
