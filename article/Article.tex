...
topographic distances} through {\em lower complete} images\footnote{A lower complete
image is an image where there is no plateaus, excepted plateaus
which are regional minima. A common way to compute the lower completion of an
image, is to add the distance from the nearest lower pixel to the pixels of all
the plateaus. Lower completion have the property to produce the same image than
the input image if the input image is already lower complete. By lower completing
an image, we introduce a new order relation in the plateaus pixels which can be
used to solve the plateaus problem with watershed.}. These
...
\begin{figure}[htbp]
\begin{center}
\subfigure[Input image]{\includegraphics[scale=0.7]{cthead1}}
\subfigure[User defined labels]{\includegraphics[scale=0.7]{cthead1-markers-rgb}}
% \subfigure[]{\includegraphics[scale=0.7]{cthead1mf-rgb}}
% \subfigure[]{\includegraphics[scale=0.7]{cthead1mF-rgb}}
% \subfigure[]{\includegraphics[scale=0.7]{cthead1Mf-rgb}}
\subfigure[Morphological watershed]{\includegraphics[scale=0.7]{cthead1MF-rgb}}
\subfigure[ITK watershed]{\includegraphics[scale=0.7]{cthead1itk-rgb}}
...
% \subfigure[]{\includegraphics[scale=0.7]{cthead1mF-rgb}}
% \subfigure[]{\includegraphics[scale=0.7]{cthead1Mf-rgb}}
\subfigure[Morphological watershed]{\includegraphics[scale=0.7]{circle_rgb2}}
\subfigure[ITK watershed]{\includegraphics[scale=0.7]{circle_rgb1}}
...
\begin{figure}[htbp]
\begin{center}
\subfigure[Input image]{\includegraphics[scale=3.2]{level}}
\subfigure[No minima level]{\includegraphics[scale=3.2]{level00-rgb}}
\subfigure[Minima level = 10]{\includegraphics[scale=3.2]{level10-rgb}}
\subfigure[Minima level = 20]{\includegraphics[scale=3.2]{level20-rgb}}
\subfigure[Minima level = 30 and Minima level = 40]{\includegraphics[scale=3.2]{level30-rgb}}
\subfigure[Minima level = 50]{\includegraphics[scale=3.2]{level50-rgb}}
\subfigure[markers]{\includegraphics[scale=3.2]{level-markers-rgb}}
\subfigure[Watershed from markers]{\includegraphics[scale=3.2]{level-markersMf-rgb}}
...
\begin{center}
\subfigure[Input image]{\includegraphics[scale=3.2]{level}}
\subfigure[No minima level]{\includegraphics[scale=3.2]{level00-itk-rgb}}
\subfigure[Level = 0.1]{\includegraphics[scale=3.2]{level10-itk-rgb}}
% \subfigure[Level = 0.2]{\includegraphics[scale=3.2]{level20-itk-rgb}}
\subfigure[Level = 0.4]{\includegraphics[scale=3.2]{level40-itk-rgb}}
\subfigure[Level = 0.63]{\includegraphics[scale=3.2]{level63-itk-rgb}}
\subfigure[Level = 0.65]{\includegraphics[scale=3.2]{level65-itk-rgb}}
\subfigure[markers]{\includegraphics[scale=3.2]{level-markers-rgb}}
\subfigure[Watershed from markers]{\includegraphics[scale=3.2]{level-markers-itk-rgb}}
...
Also, the watershed lines form a connected obejct if we consider the
...
% \subfigure[]{\includegraphics[scale=10]{pass-values-Mf-rgb}}
% \subfigure[]{\includegraphics[scale=10]{pass-values-MF-rgb}}
% \subfigure[]{\includegraphics[scale=10]{pass-values-itk-rgb}}

\subfigure[Plateau]{\includegraphics[scale=4]{plateau}}
\subfigure[$F=false$ and $M=false$]{\includegraphics[scale=4]{plateau-mf-rgb}}
\subfigure[$F=true$ and $M=false$]{\includegraphics[scale=4]{plateau-mF-rgb}}
\subfigure[$F=false$ and $M=true$]{\includegraphics[scale=4]{plateau-Mf-rgb}}
\subfigure[$F=true$ and $M=true$]{\includegraphics[scale=4]{plateau-MF-rgb}}
\subfigure[ITK]{\includegraphics[scale=4]{plateau-itk-rgb}}

\subfigure[Thick line]{\includegraphics[scale=10]{thick-lines}}
\subfigure[$F=false$ and $M=false$]{\includegraphics[scale=10]{thick-lines-mf-rgb}}
\subfigure[$F=true$ and $M=false$]{\includegraphics[scale=10]{thick-lines-mF-rgb}}
\subfigure[$F=false$ and $M=true$]{\includegraphics[scale=10]{thick-lines-Mf-rgb}}
\subfigure[$F=true$ and $M=true$]{\includegraphics[scale=10]{thick-lines-MF-rgb}}
\subfigure[ITK]{\includegraphics[scale=10]{thick-lines-itk-rgb}}
...
therefore produce a Voronoi tesselation, with the two markers being
...
sould be performed before to also solve this problem\footnote{Lower
...
1 &      0 &      -    &   -    &   -      & -     &  6.57 &   - \\
1 &      1 &      -    &   -    &   -      & -     &  11.6 &   - \\
% 0   &  0  &  2.47776 & 8.12256 & 4.29153e-07 & 0.0990558 &  10.6994 & 3.70646\\
% 0   &  1  &  2.24303 & 8.20924 & 9.53674e-07 & 0.0977524 &  10.55   & 6.22279\\
% 1   &  0  &  5.92089 & 12.2889 & 4.29153e-07 & 0.0971172 &  18.3069 & 10.7172\\
% 1   &  1  &  6.08657 & 12.222  & 5.72205e-07 & 0.0927572 &  18.4014 & 18.4605\\
\hline
\end{tabular}
...
which has the advantage to preserve the egdes of the objects.
...
in this paper, as markers. This technnique almost certainly isn't the
...
values. In this situation we are using the watershed to tesselate the
...
\begin{figure}[htbp]
\begin{center}
\subfigure[Input]{\includegraphics[scale=0.4]{leukemia-ALL-Human-b01633-Flicker-NCI}\label{fig:origGel}}
\subfigure[Regional minima]{\includegraphics[scale=0.4]{gel_minima}\label{fig:minimaGel}}
\subfigure[Background marker]{\includegraphics[scale=0.4]{gel_tesselation}\label{fig:backgroundGel}}

\subfigure[All markers]{\includegraphics[scale=0.4]{gel_allmarkers}\label{fig:combinedGel}}
\subfigure[Gradient]{\includegraphics[scale=0.4]{gel_gradient}\label{fig:gradientGel}}
\subfigure[Result (background marker removed)]{\includegraphics[scale=0.4]{gel_result}\label{fig:resultGel}}
\subfigure[All markers - stage 2]{\includegraphics[scale=0.4]{gel_allmarkers2}\label{fig:combinedGel2}}
\subfigure[Second derivative (gamma corrected)]{\includegraphics[scale=0.4]{gel_gradient2_gamma2}\label{fig:gradientGel2}}
\subfigure[Result stage 2 (background marker removed)]{\includegraphics[scale=0.4]{gel_result2}\label{fig:resultGel2}}
...
condsidered as background. These problems may be addressed in a number
