...
Figure \ref{fig:cthead1-markers} and \ref{fig:difficult-cases} illustrate
the possible problem with plateaus.
...
\begin{figure}[htbp]
\begin{center}
\subfigure[Input image]{\includegraphics[scale=3.2]{threshold}}
\subfigure[No minima threshold]{\includegraphics[scale=3.2]{threshold00-rgb}}
\subfigure[Minima threshold = 10]{\includegraphics[scale=3.2]{threshold10-rgb}}
\subfigure[Minima threshold = 20]{\includegraphics[scale=3.2]{threshold20-rgb}}
\subfigure[Minima threshold = 30 and Minima threshold = 40]{\includegraphics[scale=3.2]{threshold30-rgb}}
\subfigure[Minima threshold = 50]{\includegraphics[scale=3.2]{threshold50-rgb}}
\subfigure[markers]{\includegraphics[scale=3.2]{threshold-markers-rgb}}
\subfigure[Watershed from markers]{\includegraphics[scale=3.2]{threshold-markersMf-rgb}}
...
\begin{center}
\subfigure[Input image]{\includegraphics[scale=3.2]{threshold}}
\subfigure[No minima threshold]{\includegraphics[scale=3.2]{threshold00-itk-rgb}}
\subfigure[Level = 0.1]{\includegraphics[scale=3.2]{threshold10-itk-rgb}}
% \subfigure[Level = 0.2]{\includegraphics[scale=3.2]{threshold20-itk-rgb}}
\subfigure[Level = 0.4]{\includegraphics[scale=3.2]{threshold40-itk-rgb}}
\subfigure[Level = 0.63]{\includegraphics[scale=3.2]{threshold63-itk-rgb}}
\subfigure[Level = 0.65]{\includegraphics[scale=3.2]{threshold65-itk-rgb}}
\subfigure[markers]{\includegraphics[scale=3.2]{threshold-markers-rgb}}
\subfigure[Watershed from markers]{\includegraphics[scale=3.2]{threshold-markers-itk-rgb}}
...
systems. However, as discussed in earlier sections, the new
implementation produces more stable results than the rainfall model
and can be used in a marker based approach.
...
objects: the male and female pronucleus in a bovine embryo, around 18
...
The watershed is then performed to split the two pronucleus. A threshold
...
overlay = itk.LabelOverlayImageFilter.IUC2IUC2IRGBUC2.New(reader, mask, Opacity=0.5)
\end{verbatim} \normalsize
...
overlay2 = itk.LabelOverlayImageFilter.IUC2IUC2IRGBUC2.New(reader, mask2, Opacity=0.5)
\end{verbatim} \normalsize
...
there is some curves in the separation line of the two labels. This is the
