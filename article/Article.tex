...
approximations have been made, as mentioned in Section \ref{}, that
influence the estimation of the distance function. Even if a more
accurate underlying distance function was used the computations are
still being carried out on a grid and so are limited by the digital
